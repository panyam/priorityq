...
setup(name="priorityq",
      ...
      description="A flexible priority queue library with support for pluggable storage strategies and fast lookups and mutability.",
...
You have just installed PriorityQ over top of an existing
installation, without removing it first. Because of this,
your install may now include extraneous files from a
previous version that have since been removed from
PriorityQ. This is known to cause a variety of problems. You
should manually remove the

%(existing_path)s

directory and re-install PriorityQ.
